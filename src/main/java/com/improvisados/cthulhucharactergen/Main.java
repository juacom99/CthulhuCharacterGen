...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        Character cha=new Character("Prueba",STR,CON,SIZ,DEX,APP,INT,POW,EDU,LUK);
